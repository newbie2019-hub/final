  ...
  <div>
   <div class="row w-100 p-3">
    ...
    <div class="card p-5 mt-4">
     <h5 class="mb-4 text-primary">Update Event</h5>
     <div class="col-lg-5 col-md-6 col-5">
      ...
      <div class="mb-3">
        ...
        <p class="text-muted">Upload a new image to replace the old one</p>
        <VueFileAgent
            ref="vueFileAgent"
      ...
      <a href="" class="btn btn-sm btn-primary me-2 mt-2" v-on:click.prevent="saveUpdate">Update Event</a>
  ...
  methods: {
   ...
   filesSelected: function(fileRecordsNewlySelected) {
    ...
    async saveUpdate(){
      ...
      const event = await this.updateEvent({id: this.event.id, data: this.event});
      if (event.status == 200) {
